...
//}
//
//void LightHandler::SetDirectionalLights(ID3D11DeviceContext* context, const cs::List<DirectionalLight::Data>& data)
//{
//	HRESULT hr = {};
//
//	 Update light buffer
...
//}
//void LightHandler::SetSpotLights( ID3D11DeviceContext* context, const cs::List<SpotLight::Data>& data )
//{
//	HRESULT hr = {};
//
//	 Update light buffer
...
//}
//void LightHandler::SetPointLights( ID3D11DeviceContext* context, const cs::List<PointLight::Data>& data )
//{
//	HRESULT hr = {};
//
//	 Update light buffer
...
//	bufferDesc.ByteWidth           = LightCount * sizeof( DirectionalLight::Data);
...
//	bufferDesc.Usage               = D3D11_USAGE_DYNAMIC;
//	bufferDesc.CPUAccessFlags      = D3D11_CPU_ACCESS_WRITE;
//	bufferDesc.ByteWidth           = LightCount * sizeof( PointLight::Data);
...
//	bufferDesc.Usage               = D3D11_USAGE_DYNAMIC;
//	bufferDesc.CPUAccessFlags      = D3D11_CPU_ACCESS_WRITE;
//	bufferDesc.ByteWidth           = LightCount * sizeof( SpotLight::Data);
